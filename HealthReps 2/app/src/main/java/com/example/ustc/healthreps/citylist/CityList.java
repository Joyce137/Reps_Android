...
import com.example.ustc.healthreps.adapter.HotCityGridAdapter;
...
public class CityList extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(CurLocation.city == null){
            ...
            city_locate_state.setText(CurLocation.city);
        }
		...
		public void onReceiveLocation(BDLocation location) {
            ...
            if (location != null) {
                ...
                if ((location.getCity() != null
                        ...
                        || new GPSService(getApplicationContext()).getLocationAddress() != null){
                    locationClient.stop();
                    city_locate_failed.setVisibility(View.GONE);
                    city_locate_state.setVisibility(View.VISIBLE);
                    city_locating_progress.setVisibility(View.GONE);
